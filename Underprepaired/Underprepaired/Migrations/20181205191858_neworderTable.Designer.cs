...
namespace Underprepaired.Migrations
{
    ...
    [Migration("20181205191858_neworderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Underprepaired.Models.Order", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Underprepaired.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ID = 4, Description = "Have you ever lost half of your monocle? Look no further! The Uni-Monocle can solve all of your half-monocle problems. (No repair kit included)", ImageURL = "/img/uniMonocle.png", Name = "Uni-Monocle", Price = 49.99m },
